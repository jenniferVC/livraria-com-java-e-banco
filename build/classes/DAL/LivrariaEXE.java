...
public class LivrariaEXE {
    ...
    public static void main(String[] args) /* throws SQLException */ {
        ...
        try {
            ...
            // ** Se descomentar estas linhas, incluirá esses autores no banco de dados */
            // DA.incluir(a1);
            // DA.incluir(a2);
            // DA.incluir(a3);
            ...
            // ** Se descomentar estas linhas, incluirá esses publicadores no banco de dados
            // */
            // DP.incluir(p0);
            // DP.incluir(p1);
            ...
            // ** Se descomentar estas linhas, incluirá os respectivos livros no banco de
            // dados */
            // DB.incluir(b0);
            // DB.incluir(b1);
            // DB.incluir(b2);
                    ...
                    if (emaail != "" && psww != "") {
                        ...
                        if (compr == 1) {
                            ...
                            while (op == 1) {
                                ...
                                // SE o book consultado retornar um objeto que não seja
                                // nulo, adiciona na List Books na Classe Order
                                if (bookconsultado != null) { 
                        ...
                        case 4: // Books
                            ...
                            switch (opBook) {
                                ...
                                case 3: // consultar
                                    ...
                                    System.out.println(
                                            bookconsultado.getBoid() + " - " + bookconsultado.getAuthor().getName());
